        ...
        {activeTab === "achievements" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (
              <div
                key={index}
                className={`group relative rounded-xl border p-6 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] ${
                  theme === "dark"
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`${achievement.color} flex-shrink-0 mt-1 p-3 rounded-lg ${
        ...
        {activeTab === "certifications" && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certifications.map((cert, index) => (
              <div
                key={index}
                className={`group relative rounded-xl border p-8 hover:shadow-lg transition-all duration-300 hover:scale-[1.02] ${
                  theme === "dark"
                    ? "bg-gray-800/50 border-gray-700 hover:border-blue-500"
                    : "bg-white border-gray-200 hover:border-blue-500"
                }`}
              >
                <div className="flex flex-col items-center text-center space-y-4">
                  <div
                    className={`${cert.color} p-4 rounded-full ${theme === "dark" ? "bg-gray-700/50" : "bg-gray-50"}`}
                  >
                    {cert.icon}
                  </div>
                  <div className="space-y-2">
